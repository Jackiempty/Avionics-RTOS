...
#define AK8963_CNTL_MODE_CONTINUE_MEASURE_1 \
  (0x02)  // Continuous measurement mode 1 - Sensor is measured periodically at
          // 8Hz
#define AK8963_CNTL_MODE_CONTINUE_MEASURE_2 \
  (0x06)  // Continuous measurement mode 2 - Sensor is measured periodically at
          // 100Hz
#define AK8963_CNTL_MODE_EXT_TRIG_MEASURE \
...
/**
 * Get the Sensitivity Adjustment values.  These were set during manufacture and
 * allow us to get the actual H values from the magnetometer.
